...
const translations = {
  ...
  it: {
    ...
    'nav.download_price': 'Richiedi prezzi',
    ...
    'hero.cta_offer': 'Scopri la nostra offerta',
    'hero.cta_phone': '+48 123 456 789',
    ...
    'product.chicken_breast.desc': 'Filetti premium senza ossa né pelle. Disponibili in vari pesi: 140-200g, 200-300g, oltre 300g. Confezionati sottovuoto.',
    ...
    'product.giblets.desc': 'Frattaglie di alta qualità: cuori, ventrigli, fegati, colli. Ideali per ulteriore trasformazione.',
    'product.processed.title': 'Uova',
    'product.processed.desc': 'Uova fresche da allevamenti certificati, disponibili in diverse classi e dimensioni. Ideali per consumo e trasformazione.',
    'product.carcasses.title': 'Carcasse di pollame',
    'product.carcasses.desc': 'Carcasse fresche e surgelate, diversi pesi e confezioni. Ideali per trasformazione ed export.',
    ...
    'cert.halal.desc': 'Certificazione per mercati musulmani',
    ...
    'contact.hours.urgent': 'Per urgenze export siamo disponibili 24/7',
    ...
    'footer.copyright': '© 2024 Masovia Poultry. Tutti i diritti riservati. | Pollame polacco premium | Export mondiale',
